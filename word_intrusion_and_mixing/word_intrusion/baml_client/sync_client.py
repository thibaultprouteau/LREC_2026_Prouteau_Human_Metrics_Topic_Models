...
class BamlSyncClient:
    ...
    def WordChecker(self, word: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="WordChecker", args={
            "word": word,
        })
...
class BamlStreamClient:
    ...
    def WordChecker(self, word: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Check, types.Check]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="WordChecker", args={
            "word": word,
        })
        return baml_py.BamlSyncStream[stream_types.Check, types.Check](
          result,
...
class BamlHttpRequestClient:
    ...
    def WordChecker(self, word: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="WordChecker", args={
            "word": word,
        }, mode="request")
        return result
